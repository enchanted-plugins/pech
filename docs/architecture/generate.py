#!/usr/bin/env python
"""
Nook Architecture Generator — reads the codebase and produces:
...
<head>
<meta charset="utf-8">
<title>Nook — Architecture Explorer</title>
...
<div class="container">
  <h1>Nook <span>Architecture Explorer</span></h1>
